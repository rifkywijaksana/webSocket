  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="?id=1"><i class="glyphicon glyphicon-th-list"></i> Pengertian</a></li>
        <li><a href="?id=2"><i class="glyphicon glyphicon-th-list"></i> Simbol FLowchart</a></li>
         <li><a href="?id=3"><i class="glyphicon glyphicon-th-list"></i> Jenis FLowchart</a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
